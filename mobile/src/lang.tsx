...
const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  tgChatId: { ro: 'Telegram chat ID', ru: 'Telegram chat ID', en: 'Telegram chat ID' },
  tgHint: { ro: 'Notificări pe Telegram (rețete aprobate/respinse).', ru: 'Уведомления в Telegram.', en: 'Telegram notifications (approved/rejected recipes).' },
  tgNote: { ro: 'Află ID-ul de la botul nostru:', ru: 'Узнайте ID у нашего бота:', en: 'Get your ID from our bot:' },
